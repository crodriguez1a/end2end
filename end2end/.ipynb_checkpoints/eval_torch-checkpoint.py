...
torch.save(eval_accu, "./eval_accu0726_1.torch")
torch.save(eval_losses, "./eval_losses0726_1.torch")

torch.save(train_accu, "./train_accu0726_1.torch")
torch.save(train_losses, "./train_losses0726_1.torch")